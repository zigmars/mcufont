...
struct mf_font_s {
    ...
    uint8_t (*render_character)(const struct mf_font_s* font, int16_t x0,
...
MF_EXTERN uint8_t mf_render_character(const struct mf_font_s* font, int16_t x0,
                                      int16_t y0, mf_char character,
...
MF_EXTERN void mf_character_whitespace(const struct mf_font_s* font,
                                       mf_char character, uint8_t* left,
                                       uint8_t* top, uint8_t* right,
                                       uint8_t* bottom);
