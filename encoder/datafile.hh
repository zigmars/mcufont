...
class DataFile {
  public:
    ...
    size_t GetLowScoreIndex() const { return m_lowscoreindex; }

    // Get an entry in the glyph table.
    size_t GetGlyphCount() const { return m_glyphtable.size(); }
    ...
    const fontinfo_t& GetFontInfo() const { return m_fontinfo; }
...
class DataFileTests : public CxxTest::TestSuite {
  public:
    void testFileLoad() {
        ...
        DataFile::pixels_t expected = {0, 15, 0, 15, 0, 15, 0, 15,
                                       0, 15, 0, 15, 0, 15, 0, 15,
                                       0, 15, 0, 15, 0, 15, 0, 15};
